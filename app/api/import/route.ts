...
type ImportProject = { companyCnpj?: string; companyName?: string; companyId?: number; opportunityId?: number; opportunitySourceCode?: string; opportunityTitle?: string; name: string; status?: string; startDate?: string; endDate?: string; manager?: string; responsibleUserId?: number; handoffProgress?: number; handoverProgress?: number; totalValue?: number };
