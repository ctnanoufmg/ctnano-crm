...
const fallback: Snapshot = {
  ...
  kpis: [
    ...
    { id: 11, key: "average_opportunity_registration_time", label: "Tempo médio de cadastro de oportunidades", unit: "Outro", direction: "Quanto menor, melhor", weight: 3, measurementMethod: "Tempo médio entre envio da proposta e cadastro no CRM", showOnDashboard: false, targets: [2026, 2027, 2028, 2029, 2030].map((year) => ({ year, target: 2, manualActual: 0 })), manualActual2026: 0, manualActual2027: 0, manualActual2028: 0, target2026: 2, target2027: 2, target2028: 2 },
    { id: 12, key: "average_prospecting_registration_time", label: "Tempo médio de cadastro de prospecções", unit: "Outro", direction: "Quanto menor, melhor", weight: 3, measurementMethod: "Tempo médio entre prospecção e cadastro no CRM", showOnDashboard: false, targets: [2026, 2027, 2028, 2029, 2030].map((year) => ({ year, target: 2, manualActual: 0 })), manualActual2026: 0, manualActual2027: 0, manualActual2028: 0, target2026: 2, target2027: 2, target2028: 2 },
  ],
  backups: [],
